...
\begin{rubriquetableau}[3cm]{Skills}
  ...
  & \begin{itemize}
      ...
      \item Kernels: Linux, QNX, Windows NT
  ...
  & \begin{itemize}
      ...
      \item Xilinx FPGAs (VIRTEX, KINTEX series) and toolsuite
      \end{small}
    \end{itemize}
  \\[0mm]
  ...
  & \begin{itemize}
      ...
      \item Protocols design and implementation for resource constrained applications
      \end{small}
    \end{itemize}
  \\[0mm]
