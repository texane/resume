...
\begin{rubriquetableau}[3cm]{Employment}
  \small{2012 - present}
  & \activite{\small{Software and Electronics engineer at ESRF (fixed term, 2.5 years)}}
  \begin{small}
    \begin{itemize}
    \item Data acquisition and control for XRay instruments
      \begin{itemize}
      \item high performance Linux software stack and drivers
      \item blocks for PCIe and 10GbE FPGA based hardware
...
\begin{rubriquetableau}[3cm]{Skills}
  ...
  & \begin{itemize}
      \begin{small}
      \item electronic circuit design (EAGLE) and simulation (SPICE)
      \item SOLIDWORKS
