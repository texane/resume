...
\begin{center}
  \textbf{\huge{Software and Digital Electronics Engineer}}
\end{center}
...
\begin{rubriquetableau}[3cm]{Employment}
  \small{2012 - present}
  & \activite{\small{Software and Digital Electronics engineer at ESRF}}
  \begin{small}
    \begin{itemize}
    \item Design and implementation of data acquisition and control framework for XRay instruments
      \begin{itemize}
      \item PCIe over cable and 10GbE FPGA based DMA engine
      \item high performance LINUX software stack and drivers
      \item embedded LINUX system for acquisition and control platforms
