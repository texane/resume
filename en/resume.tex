...
\begin{rubriquetableau}[3cm]{Employment}
  \small{2018}
  & \activite{\small{Software engineer at SOGETI High Tech (permanent position)}}
  \begin{small}
    \begin{itemize}
    \item Refactoring of the SNCF railway company supervision infrastructure
      \begin{itemize}
      \item OPC-UA server for data acquisition
...
\begin{rubriquetableau}[3cm]{Open Source Projects}
  ...
  \begin{small}
    ...
    \item >1000 users, >100 contributors
    \end{itemize}
  \end{small}
  \\[0.6mm]
...
\begin{rubriquetableau}[3cm]{Skills}
  ...
  & \begin{itemize}
      \begin{small}
      \item Programming languages: C/C++, Java, Assembly, Python, VHDL, OpenMP, CUDA
      \item Kernels: Linux, Windows NT, realtime kernels
      \item Scientific: Matlab, Simulink, linear algebra, image and signal processing, machine learning
      \end{small}
    \end{itemize}
  \\[0mm]
  ...
  & \begin{itemize}
      \begin{small}
      \item Microprocessors: IA32, ARM (AM335x and CORTEX series), SPARC
      \item Microcontrollers: MIPS SoC, Microchip PICs, Renesas RX62N, AVR
      \item FPGAs: Xilinx Spartan, Kintex, Virtex series
      \end{small}
    \end{itemize}
  \\[0mm]

  \textbf{\small{Electronics}}
  & \begin{itemize}
      \begin{small}
      \item schematics design, board routing, soldering
      \item components sourcing (power supply, analog digital ...)
      \item signal conditionning and filtering
      \item interfacing (bus transceivers, sensors ...)
      \end{small}
    \end{itemize}
  \\[0mm]
  ...
  & \begin{itemize}
      \begin{small}
      \item TCP-IP, IPv6, Ethernet, 802.11, RF, SDR
      \item PCIe, 10GbE, USB, CAN, I2C, SPI, industrial buses (MODBUS ...)
      \item Protocol design and implementation for resource constrained applications
      \item Security: cryptography, software and network reverse engineering
      \end{small}
    \end{itemize}
  \\[0mm]
