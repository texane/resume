...
\begin{rubriquetableau}[3cm]{Employment}
  ...
  \begin{small}
    ...
    \item Control and data acquisition for physics instruments
      ...
      \item motor encoding electronics and software
      \item PoE supply stage
...
\begin{rubriquetableau}[3cm]{Skills}
  ...
  & \begin{itemize}
      \begin{small}
      \item Programming languages: C/C++, Java, Assembly, Python, VHDL
      ...
      \item Scientific: Matlab, linear algebra, image and signal processing, classification algorithms
      \end{small}
    \end{itemize}
  \\[0mm]
  ...
  & \begin{itemize}
      ...
      \item FPGAs: Xilinx VIRTEX and KINTEX series
      \end{small}
    \end{itemize}
  \\[0mm]
